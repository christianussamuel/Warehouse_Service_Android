...
public class MainActivityImg extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_activity_img);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(productName.getText().toString().length()==0){
                    ...
                    if(ret == 1){
                        Toast.makeText(MainActivityImg.this, "Product Added!", Toast.LENGTH_SHORT).show();

                    }else
                        Toast.makeText(MainActivityImg.this, "Gagal Insert", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadImage(){
        class UploadImage extends AsyncTask<Bitmap,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MainActivityImg.this, "Uploading...", null,true,true);
            }
